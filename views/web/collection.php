...
<head>
	...
	<link rel="stylesheet" href="assets/css/main.css?version=4158" />
...
<body class="no-sidebar is-preload">
	<div id="page-wrapper">
		...
		<section id="banner">
			<header>
				<h2>Conheça o <strong>nosso acervo</strong> completo.</h2>
			</header>
		</section>
		...
		<section class="carousel">
			<header class="center title">
				<h2>Primeira categoria</h2>
			</header>

			<div class="reel">
				<article>
					<a href="images/pic01.jpg" class="image featured" data-lightbox="mygallery"><img src="images/pic01.jpg" alt="" /></a>
					<header>
				...
				<article>
					<a href="images/pic01.jpg" class="image featured" data-lightbox="mygallery"><img src="images/pic02.jpg" alt="" /></a>
					<header>
						<h3><a href="#">Nome da peça</a></h3>
					</header>
					<p>Commodo id natoque malesuada sollicitudin elit suscipit magna.</p>
