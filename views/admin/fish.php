...
<body>
  ...
  <div class="content table-page">
    ...
    <div class="table-content">
      <h1>Espécie selecionada</h1>
      <div class="table-responsive">
        <table class="table table-striped">
          <thead class="thead-dark">
            <tr>
              <th class="order" scope="col">ID <i class="fas fa-sort"></i></th>
              <th class="order" scope="col">Espécie <i class="fas fa-sort"></i></th>
              <th class="order" scope="col">Sexo <i class="fas fa-sort"></i></th>
              <th class="order" scope="col">Comp. Padrão <i class="fas fa-sort"></i></th>
              <th class="order" scope="col">Comp. Total <i class="fas fa-sort"></i></th>
              <th class="order" scope="col">Peso <i class="fas fa-sort"></i></th>
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Editar peixe 1</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
